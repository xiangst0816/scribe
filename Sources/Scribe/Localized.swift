...
enum L10n {
    ...
    private static let strings: [String: [String: String]] = [
        "en": [
            ...
            "settings.polish.local.label":     "Scribe local model (Qwen2.5-1.5B, ~1 GB download)",
        ...
        "zh-Hans": [
            ...
            "settings.polish.local.label":     "Scribe 本地模型（Qwen2.5-1.5B，需下载约 1 GB）",
        ...
        "zh-Hant": [
            ...
            "settings.polish.local.label":     "Scribe 本機模型（Qwen2.5-1.5B，需下載約 1 GB）",
        ...
        "ja": [
            ...
            "settings.polish.local.label":     "Scribe ローカルモデル（Qwen2.5-1.5B、約 1 GB のダウンロード）",
        ...
        "ko": [
            ...
            "settings.polish.local.label":     "Scribe 로컬 모델(Qwen2.5-1.5B, 약 1 GB 다운로드)",
