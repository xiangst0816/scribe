...
enum L10n {
    ...
    private static let strings: [String: [String: String]] = [
        "en": [
            ...
            // Overlay (post-recording HUD)
            "overlay.copiedToClipboard":   "Copied to clipboard",
            // Alerts
            ...
            "settings.polish.adaptive.label":     "Adapt to my voice over time (advanced)",
            "settings.polish.adaptive.detail":    "Scribe will keep the text of your last 5 dictations and a short profile to learn what you write like. Text only — never uploaded.",
            "settings.polish.adaptive.persona":   "About you (write a few sentences in your own voice):",
            "settings.polish.adaptive.placeholder": "e.g. I'm a backend engineer who mixes Mandarin and English freely; I prefer concise messages and keep contractions like \"I'll\".",
            "settings.polish.adaptive.openFolder": "Open Scribe folder in Finder",
            "settings.polish.adaptive.reset":      "Reset profile and history",
            "settings.polish.adaptive.resetConfirm.title":   "Reset your Scribe profile?",
            "settings.polish.adaptive.resetConfirm.body":    "This deletes your written profile and the last 5 dictations Scribe remembers. Cannot be undone.",
            "settings.polish.adaptive.resetConfirm.confirm": "Reset",
            "settings.polish.adaptive.resetConfirm.cancel":  "Cancel",
        ],
        "zh-Hans": [
            "menu.enabled":            "启用",
            "menu.language":           "语言",
            ...
            "overlay.copiedToClipboard":   "已复制到剪贴板",
            ...
            "settings.polish.adaptive.label":     "学习我的口吻（高级）",
            "settings.polish.adaptive.detail":    "Scribe 会保留你最近 5 条听写文本和一段简短画像，用来理解你的写作风格。仅保存文字，绝不上传。",
            "settings.polish.adaptive.persona":   "关于你（用自己的口吻写几句话介绍自己）：",
            "settings.polish.adaptive.placeholder": "例如：我是后端工程师，习惯中英文混用，偏好简短的消息，常用「就这样」、「OK」之类口语化表达。",
            "settings.polish.adaptive.openFolder": "在 Finder 中打开 Scribe 目录",
            "settings.polish.adaptive.reset":      "清空画像和历史",
            "settings.polish.adaptive.resetConfirm.title":   "确认清空 Scribe 画像？",
            "settings.polish.adaptive.resetConfirm.body":    "将删除你写的画像和最近 5 条听写记录，无法恢复。",
            "settings.polish.adaptive.resetConfirm.confirm": "清空",
            "settings.polish.adaptive.resetConfirm.cancel":  "取消",
        ],
        "zh-Hant": [
            "menu.enabled":            "啟用",
            "menu.language":           "語言",
            ...
            "overlay.copiedToClipboard":   "已複製到剪貼板",
            ...
            "settings.polish.adaptive.label":     "學習我的口吻（進階）",
            "settings.polish.adaptive.detail":    "Scribe 會保留你最近 5 條聽寫文字和一段簡短描述，藉此理解你的寫作風格。僅保存文字，絕不上傳。",
            "settings.polish.adaptive.persona":   "關於你（用自己的口吻寫幾句話介紹自己）：",
            "settings.polish.adaptive.placeholder": "例如：我是後端工程師，習慣中英文混用，偏好簡短訊息，常用「就這樣」、「OK」之類的口語表達。",
            "settings.polish.adaptive.openFolder": "在 Finder 中開啟 Scribe 資料夾",
            "settings.polish.adaptive.reset":      "清除個人描述與歷史",
            "settings.polish.adaptive.resetConfirm.title":   "確認清除 Scribe 個人描述？",
            "settings.polish.adaptive.resetConfirm.body":    "將刪除你寫的個人描述和最近 5 條聽寫紀錄，無法復原。",
            "settings.polish.adaptive.resetConfirm.confirm": "清除",
            "settings.polish.adaptive.resetConfirm.cancel":  "取消",
        ],
        "ja": [
            "menu.enabled":            "有効",
            ...
            "overlay.copiedToClipboard":   "クリップボードにコピーしました",
            ...
            "settings.polish.mirror.auto":       "自動",
            "settings.polish.adaptive.label":     "あなたの口調を学習する（上級）",
            "settings.polish.adaptive.detail":    "Scribe は直近 5 件の文字起こしと短いプロフィールを保持して、あなたの書き方を学びます。テキストのみで、外部へ送信することはありません。",
            "settings.polish.adaptive.persona":   "あなたについて（自身の口調で簡単に紹介してください）：",
            "settings.polish.adaptive.placeholder": "例：私はバックエンドエンジニアで、日本語と英語を混ぜて使います。簡潔な文を好み、専門用語はそのまま残してください。",
            "settings.polish.adaptive.openFolder": "Finder で Scribe フォルダを開く",
            "settings.polish.adaptive.reset":      "プロフィールと履歴を消去",
            "settings.polish.adaptive.resetConfirm.title":   "Scribe のプロフィールを消去しますか？",
            "settings.polish.adaptive.resetConfirm.body":    "あなたが書いたプロフィールと直近 5 件の文字起こしを削除します。この操作は取り消せません。",
            "settings.polish.adaptive.resetConfirm.confirm": "消去",
            "settings.polish.adaptive.resetConfirm.cancel":  "キャンセル",
        ],
        "ko": [
            "menu.enabled":            "사용",
            "menu.language":           "언어",
            ...
            "overlay.copiedToClipboard":   "클립보드에 복사됨",
            ...
            "settings.polish.adaptive.label":     "내 말투 학습하기 (고급)",
            "settings.polish.adaptive.detail":    "Scribe가 최근 받아쓰기 5건과 짧은 프로필을 보관해 사용자의 글쓰기 스타일을 익힙니다. 텍스트만 저장되며 외부로 전송되지 않습니다.",
            "settings.polish.adaptive.persona":   "당신에 대해(자기 말투로 짧게 소개해 주세요):",
            "settings.polish.adaptive.placeholder": "예: 저는 백엔드 엔지니어이고 한국어와 영어를 섞어 씁니다. 짧은 메시지를 선호하고, 기술 용어는 그대로 두는 편입니다.",
            "settings.polish.adaptive.openFolder": "Finder에서 Scribe 폴더 열기",
            "settings.polish.adaptive.reset":      "프로필과 기록 초기화",
            "settings.polish.adaptive.resetConfirm.title":   "Scribe 프로필을 초기화할까요?",
            "settings.polish.adaptive.resetConfirm.body":    "직접 작성한 프로필과 최근 받아쓰기 5건이 삭제됩니다. 되돌릴 수 없습니다.",
            "settings.polish.adaptive.resetConfirm.confirm": "초기화",
            "settings.polish.adaptive.resetConfirm.cancel":  "취소",
        ],
    ]
}
